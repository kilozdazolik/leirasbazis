...
<head>
    ...
    <title>Szerkeszéts - LeírásBázis</title>
</head>
    ...
    <div class="admin-wrapper">
        ...
        <div class="admin-content">
            ...
            <div class="content">
                ...
                <h2 class="page-title">Felhasználó szerkesztése</h2>
                ...
                <form action="edit.php" method="post">
                    ...
                    <div>
                        <button type="submit" name="update-user" class="btn btn-big">Frissítés</button>
                    </div>
                </form>
